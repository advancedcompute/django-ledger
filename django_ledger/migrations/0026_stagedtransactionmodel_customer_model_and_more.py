    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('receipt_date', models.DateField(verbose_name='Receipt Date', default=get_localdate, null=True)),
                ('receipt_type', models.CharField(max_length=15, choices=[('sales', 'Sales Receipt'), ('customer_refund', 'Sales Refund'), ('expense', 'Expense Receipt'), ('expense_refund', 'Expense Refund'), ('transfer', 'Transfer Receipt')], verbose_name='Receipt Type')),
